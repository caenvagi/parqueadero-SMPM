<?php
    ...
    // Para guardar el usuario nuevo
        ...
        if(isset($_POST['register'])){        
            if(strlen($_POST['nombre'])){
                ...
                $consulta = "   INSERT INTO usuarios(nombre, telefono, usuario, clave, tipo_usuario, tipo_cargo, avatar, activo, contabilidad) 
                                VALUES ('$nombre','$telefono','$usuario','$clave','$tipo','$cargo','$foto','$activo' ,'$contabilidad')";
    ...
    // Para guardar el usuario nuevo fin 
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="hidden" name="id" id="id" value="<?php echo $id; ?>" readonly></input>
