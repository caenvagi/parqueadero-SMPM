                        ...
                        <div class="row justify-content">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card p-2 "> 
                                    ...
                                    <!-- tabla cargos -->
                                        <div class="justify-content-between m-0 col col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10">
                                            <div>
                                                Roles usuarios:
                                            </div>
                                            <table id="tabla_cargos" class="table table table-lg table-borderless table-hover mt-3 table text-center table align-middle">
                                                <thead>
                                                    <tr>
