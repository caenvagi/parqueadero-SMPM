<?php
    ...
    $movimientos = $mysqli->query   ("  SELECT          id_movimiento,
                                            ...
                                            INNER JOIN  usuarios Us         ON Ca.user_login    = Us.id   
                                                                                ...
                                                                                <!-- <input name="id_movimiento" value="<?php echo $id_movimiento ?>"  type="hidden" class="form-control"  placeholder="id_movimiento" aria-label="id_movimiento" aria-describedby="basic-addon1" required autofocus> -->
                                                                                    <div class="text-center">
                                                                                        ...
                                                                                        <div class="form-floating m-2">
                                                                                            <input type="Date" name="fecha_movimiento" class="form-control" id="floatingInput" placeholder="Fecha" required>
                                                                                        ...
                                                                                        <div class="form-floating m-2">
                                                                                            <input type="text" name="desc_movimiento" class="form-control" id="floatingInput" placeholder="Descripcion" required>
                                                                                            <label for="floatingInput">Descripcion</label>
                                                                                        </div>
                                                                                        
                                                                                        <div class="form-floating m-2">
                                                                                            <input type="text" name="valor" class="form-control" id="floatingPassword" placeholder="Valor" required>
                                                                        ...
                                                                        <form id="movimientos" name="movimientos" class="row g-0 p-2" action="consulta/ingreso.php" method="POST">
                                                                            <!-- <input name="id_movimiento" value="<?php echo $id_movimiento ?>"  type="hidden" class="form-control"  placeholder="id_movimiento" aria-label="id_movimiento" aria-describedby="basic-addon1" required autofocus> -->
                                                                                <div class="text-center">
                                                                                    ...
                                                                                    <div class="form-floating m-2">
                                                                                        <input type="Date" value="" name="fecha_movimiento" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                                                                                        <label for="floatingInput">Fecha:</label>
                                                                                    </div>
