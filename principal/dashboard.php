        ...
        <div id="layoutSidenav_content" class="bg-light">
            <main class="principal" >        
                ...
                <!--card datos del parqueadero --------------------------------->
                    <div id="row_informacion" class="row mt-2 gap-1 align-content-center align-items-center text-align-center justify-content-center" >
                        ...
                        ?>
                        <div id="cards_informacion_1" class="container ms-2  me-2 mb-sm-2 card text-white col col-11 col-sm-5 col-md-3 col-lg-3" >
                            <div class="row" >
                        ...
                        while ($fila = $cantVehdia->fetch_array()) {
                            ...
                            $catImg = $fila['cat_imagen'];
                        ?>
                        <div id="cards_informacion_2" class="container me-2 mb-sm-2 card text-white col col-11 col-sm-5 col-md-3 col-lg-3" >
                            <div class="row" >
                                <div class="col-3 col-sm-3 col-md-3 col-lg-4 col-xl-4" id="cards_informacion_logo">
                        ...
                        <div id="cards_informacion_3" class="container me-2 mb-sm-2 card  text-white col col-11 col-sm-5 col-md-3 col-lg-3" >
                            <div class="row" >
                                <div class="col-3 col-sm-3 col-md-3 col-lg-4 col-xl-4" id="cards_informacion_logo">
